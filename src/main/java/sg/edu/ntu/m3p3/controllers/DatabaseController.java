...
public class DatabaseController {
    ...
    @Operation(summary = "Retrieve all tables in DB", description = "Get a list of all Tables.", tags = {})
    @GetMapping("/tables")
    ...
    @Operation(summary = "Retrieve table schema", description = "Retrieve table schema", tags = {})
